<?php /*a:2:{s:38:"E:\tp\src\app\admin\view\giftlist.html";i:1620817367;s:43:"E:\tp\src\app\admin\view\common\common.html";i:1620829982;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <ul class="layui-nav layui-nav-tree" lay-filter="test" lay-shrink="all">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            ...
            <dd class="
layui-this
"><a href="<?php echo url('gift/list'); ?>">活动列表</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
